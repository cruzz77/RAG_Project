...
st.set_page_config(
    page_title="Lumina RAG AI",
    page_icon="✨",
    layout="wide",  
    initial_sidebar_state="expanded"
)

# 🎨 Updated Custom CSS with new UI features
st.markdown("""
<style>
    /* 🎯 TARGET: Entire app background */
    .stApp {
    ...
    /* 🎯 TARGET: All block containers */
    .block-container {
        background-color: #000000;
    }
    
    /* 🎯 TARGET: Make all text white for contrast */
    .stApp * {
    ...
    .upload-header-text {
        ...
        color: white;
        font-weight: 600;
        box-shadow: 0 15px 25px rgba(198, 75, 140, 0.3),
                    0 4px 6px rgba(198, 75, 140, 0.2);
    ...
    .upload-header-text:hover {
        transform: translateY(-2px);
        box-shadow: 0 6px 16px rgba(198, 75, 140, 0.4),
                    0 3px 6px rgba(198, 75, 140, 0.3);
    }
...
with col2:
    ...
    st.markdown("<h3 style='text-align: center;'>Your Document Analysis Tool</h3>", unsafe_allow_html=True)
...
# 📄 PDF Upload Section with new UI
st.markdown("### 📤 <span class='upload-header-text'>Upload PDF Document</span>", unsafe_allow_html=True)
with st.container():
...
if uploaded is not None:
    ...
    st.success(f"✅ PDF document **{path.name}** uploaded and ready for questions!")
...
# 💬 Question Input with new UI
st.markdown("### 💭 <span class='question-header-text'>Ask a Question</span>", unsafe_allow_html=True)
